...
(function() {
  $(function() {
    ...
    return $('.show-comments').on('click', function(e) {
      var comments_container, spinner;
      comments_container = $(this).siblings('.comments-container');
      spinner = $(this).siblings('.spinner');
      e.preventDefault();
      spinner.show();
      $(this).hide();
      return $.get($(this).data('url'), function(comments) {
        console.log(comments);
        comments.forEach(function(comment) {
          var newComment;
          newComment = Mustache.render($('#comment-template').html(), comment);
          return $(newComment).appendTo(comments_container);
        });
...
(function() {
  ...
  channel.bind('update_vote', function(post) {
    return $(".votes_count[data-id=" + post.id + "]").text(post.points);
  });
